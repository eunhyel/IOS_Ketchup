...
extension UIFont {
    ...
    @objc private class func mySystemFont(ofSize size: CGFloat) -> UIFont {
        ...
        return UIFont(name: font.defaultFont, size: size) ?? UIFont.systemFont(ofSize: UIFont.systemFontSize)
    }
    ...
    fileprivate static func setNavbarFont() {
        ...
        titleAttr.updateValue( UIFont(name: font.semibold ?? font.defaultFont, size: 17) ?? UIFont.systemFont(ofSize:17), forKey:  NSAttributedString.Key.font)
